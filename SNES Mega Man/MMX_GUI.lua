...
function enemies()
	...
	for i = 0, 13 , 1 do		
		...
		-- print("Enemy: " .. memory.readbyte(adjustAddr(0x7E0000 + base + 0xA)));
...
if is_snes9x then
	...
	if memory.readbyte(adjustAddr(0x7FCD00)) < 0xEE then
		AP_ROM = true
		print ("AP ROM Found! " .. memory.readbyte(adjustAddr(0x7FCD00)))
	end	
	memory.usememorydomain("WRAM")
